...
import type { SiteTouristique } from '../types';

export default function TourismePage() {
  const { data: sites, loading, error } = useFetch<SiteTouristique[]>('/sites-touristiques');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-rose-50">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        ...
        {error && (
          <div className="bg-red-50 border-2 border-red-200 text-red-700 rounded-xl p-6 text-center">
            <p className="font-semibold">Impossible de charger les sites touristiques</p>
